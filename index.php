...
session_start();
include 'header.php';
include 'Pages/database_connection.php'; // Provides the $pdo connection
            ...
            <div class="product-grid">
                <?php foreach ($products as $product): ?>
                    <div class="product-card">
                        ...
                        <?php if (isset($_SESSION['user_id'])): ?>
                            <a href="Pages/checkout.php?product_id=<?= urlencode($product['product_id']) ?>" class="btn">Buy Now</a>
                            <a href="Pages/add_to_cart.php?product_id=<?= urlencode($product['product_id']) ?>" class="btn btn-cart">Add to Cart</a>
                        <?php else: ?>
                            <a href="Pages/login.php?redirect=Pages/checkout.php?product_id=<?= urlencode($product['product_id']) ?>" class="btn">Buy</a>
                            <a href="Pages/login.php?redirect=Pages/cart.php" class="btn btn-cart">Add to Cart</a>
                        <?php endif; ?>
                    </div>
                <?php endforeach; ?>
            </div>
