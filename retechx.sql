...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 15, 2025 at 04:45 AM
...
INSERT INTO `pickup_slots` (`id`, `slot_id`, `seller_id`, `slot_date`, `slot_time`, `status`) VALUES
(1, 1, 7, '2025-04-29', '14:00:00', 'Confirmed');
...
CREATE TABLE `seller_info` (
  ...
  `equipment_type` varchar(150) NOT NULL DEFAULT '',
  `equipment_condition` varchar(250) NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `seller_info` (`id`, `name`, `email`, `phone`, `address`, `preferred_date`, `preferred_time`, `created_at`, `equipment_type`, `equipment_condition`) VALUES
...
(7, 'Siddharth R', 'sid@hotmail.com', '4098790098', '25, Winston churchill Dr', '2025-04-29', '9:00-11:00', '2025-04-14 22:45:01', 'Phone', 'The condition of your device is good, and the price will be moderate.');
...
--
ALTER TABLE `pickup_slots`
  ADD CONSTRAINT `pickup_slots_ibfk_1` FOREIGN KEY (`seller_id`) REFERENCES `seller_info` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
